...
% https://www.overleaf.com/latex/examples/moderncv-with-modern-timeline/prmmmvtvfxsn
...
\makeatletter
\newcommand{\tlrightdatecventry}[7][color1]{%
\issincefalse
\tl@formatstartyear{#2}
\cventry{\tikz[
  baseline=0pt,
  rightalign/.style={font=\scriptsize, name=rightalign, above=\tl@textstartabove, inner xsep=0pt, anchor=base east}]{
    \useasboundingbox (0,-1.5ex) rectangle (\hintscolumnwidth,1ex);
    \fill [\tl@runningcolor] (0,0)
       rectangle (\hintscolumnwidth,\tl@runningwidth);
    \fill [#1] (0,0)
...
\makeatletter
\newcommand{\tlleftcventry}[8][color1]{%
%    \end{macrocode}
%    \begin{macrocode}
\tl@formatendyear{#3}
\tl@formatstartyear{#2}
 \cventry{\tikz[
  baseline=0pt,
  leftaligned/.style={font=\scriptsize, name=tl@endyear, below, inner xsep=0pt, anchor=north west}
  ]{
    \useasboundingbox (0,-1.5ex) rectangle (\hintscolumnwidth,1ex);
    \fill [\tl@runningcolor] (0,0)
       rectangle (\hintscolumnwidth,\tl@runningwidth);
