\tlcventry{2015/1}{0}{\href{https://github.com/hafen/trelliscopejs}{\pkg{trelliscopejs}}}{\textnormal{Create Interactive Trelliscope Displays}}{\emph{Purdue University}}{}{
  \begin{itemize}
